...
if ($action == 'forgot-password') {
    ...
    if (setResetToken($conn, $user['id'], $token)) {
        ...
        // for now just show token in success message
        $_SESSION['success'] = "Password reset link: index.php?page=reset-password&token=" . $token;
        header("Location: ../../public/index.php?page=forgot-password");
    } else {
        $_SESSION['error'] = "Failed to generate reset link. Please try again";
        header("Location: ../../public/index.php?page=forgot-password");
    }
    exit();
}
